...
<main>
  ...
  <section class="container text-center">
    ...
    <Route path="/">
      ...
      <button type="button" on:click={gotoSensor}>View Sensor</button><br/>
      <button type="button" on:click={gotoWifiForm}>WiFi Settings</button><br/>
      <button type="button" on:click={gotoMqttForm}>MQTT Settings</button><br/>
